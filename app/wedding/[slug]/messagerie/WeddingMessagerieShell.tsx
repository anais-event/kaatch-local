...
export default function WeddingMessagerieShell({
  slug,
  groups,
  authorName,
  weddingId,
  ...
  async function handleCreate(name: string) {
    ...
    await fetch(`/api/groupes`, {
      ...
      body: JSON.stringify({ slug, name, author: authorName, weddingId }),
    })
    setCreating(false)
              ...
              <a key={group.id} href={`/wedding/${slug}/messagerie/${group.id}`}
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {group.lastMsg ? (
                    ...
                    <p className="text-xs text-stone-300 italic" style={{ fontWeight: 300 }}>Aucun message</p>
                  )}
                </div>
                {group.lastMsg && (
