...
const lineItems = [
  { id: 'venue', label: '🏛️ Lieu de réception', details: 'Location salle, château, domaine, parc', intimate: 2500, convivial: 5000, grandiose: 9000, perGuest: false, feature: { label: '✨ Plan de table sur Kaatch', href: '/fonctionnalites/plan-de-table' } },
  ...
  { id: 'photographer', label: '📸 Photo & vidéo', details: 'Photographe, vidéaste, drone, album', intimate: 1200, convivial: 2200, grandiose: 4000, perGuest: false, feature: { label: '✨ Album partagé invités', href: '/fonctionnalites/album-photo' } },
  { id: 'dj', label: '🎵 Animation & musique', details: 'DJ, groupe, cérémonie laïque, animations', intimate: 400, convivial: 800, grandiose: 1800, perGuest: false, feature: { label: '✨ Playlist collaborative', href: '/fonctionnalites/playlist-collaborative' } },
  ...
  { id: 'stationery', label: '✉️ Papeterie & faire-part', details: 'Faire-part, save the date, menus, plan de table', intimate: 100, convivial: 300, grandiose: 600, perGuest: false, feature: { label: '✨ Faire-part animés Kaatch', href: '/fonctionnalites/faire-part-rsvp' } },
  ...
  { id: 'accommodation', label: '🏨 Hébergement', details: 'Nuit mariés, chambres invités/famille', intimate: 0, convivial: 600, grandiose: 1500, perGuest: false, feature: { label: '✨ Espace invités Kaatch', href: '/fonctionnalites/espace-invites' } },
