      ...
      {dropdownOpen && (
        <div className="absolute right-0 top-full mt-1.5 bg-white rounded-xl shadow-xl border border-stone-100 py-1.5 z-50 w-[220px] max-w-[calc(100vw-2rem)]">
          ...
          <a href={`sms:?body=${smsMsg}`}
            ...
            <div>
              <p style={{ fontWeight: 400, fontSize: '0.82rem' }} className="text-stone-700">SMS</p>
              <p style={{ fontWeight: 300, fontSize: '0.68rem' }} className="text-stone-400">Ouvre l'application SMS</p>
            </div>
          </a>
