        ...
        <div className="border-t border-stone-100 px-2 py-3">
          ...
          <div className="relative">
            <button
              ...
              className="w-full flex items-center gap-2.5 px-3 py-2 rounded-lg text-xs text-stone-600 hover:bg-stone-100 hover:text-[#4a5240] transition cursor-pointer"
              style={{ fontFamily: 'var(--font-lato)', fontWeight: 400 }}
            >
            ...
            {paramsOpen && (
              <div className="mb-1 bg-stone-50 rounded-xl border border-stone-100 overflow-hidden">
