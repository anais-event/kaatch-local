      ...
      <div className="min-h-screen bg-[#f5f0e8]" style={{ fontFamily: 'var(--font-lato)' }}>
        ...
        <div className="max-w-lg mx-auto">
          ...
          <div className="relative w-full h-[55vh] min-h-[300px] overflow-hidden">
            ...
            {/* Bouton imprimer — coin haut droit */}
            <button
              onClick={() => window.print()}
              className="no-print absolute top-4 right-4 flex items-center gap-1.5 text-xs text-white/80 hover:text-white border border-white/30 hover:border-white/60 px-3 py-1.5 rounded-lg backdrop-blur transition"
