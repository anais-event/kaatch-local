      ...
      {lightbox && currentPhoto && (
        <div className="fixed inset-0 z-50 bg-black" style={{ touchAction: 'none' }}
          ...
          {photos.length > 1 && (<>
            ...
            <button onClick={e => { e.stopPropagation(); nextPhoto() }} className="absolute right-3 md:right-72 top-1/2 -translate-y-1/2 w-10 h-10 rounded-full bg-white/10 hover:bg-white/20 transition flex items-center justify-center cursor-pointer z-10">
