    ...
    <div className="min-h-screen bg-[#f5f0e8]" style={{ fontFamily: 'var(--font-lato)', fontWeight: 300 }}>
      <div className="max-w-lg mx-auto px-6 pt-8 pb-28">
        ...
        <div className="bg-white rounded-2xl border border-stone-100 p-5 mb-3">
          <p style={labelStyle} className="mb-3">Identité</p>
          <div className="flex items-center gap-4">
            ...
            <div>
              <p style={{ fontWeight: 300, fontSize: '0.9rem', color: '#3a3a37' }}>{guestName || 'Invité(e)'}</p>
        ...
        {/* Mariage */}
        <div className="bg-white rounded-2xl border border-stone-100 p-5 mb-3">
          <p style={labelStyle} className="mb-3">Mariage</p>
        ...
        {/* Mon invitation */}
        <div className="bg-white rounded-2xl border border-stone-100 p-5 mb-3">
          <p style={labelStyle} className="mb-3">Mon invitation</p>
        ...
        {/* RSVP */}
        <div className="bg-white rounded-2xl border border-stone-100 p-5 mb-3">
          <p style={labelStyle} className="mb-3">Ma réponse</p>
          {rsvp === 'confirme' && (
            <p style={{ fontWeight: 300, fontSize: '0.85rem', color: '#3a3a37' }}>Présence confirmée</p>
          )}
          {rsvp === 'decline' && (
            <p style={{ fontWeight: 300, fontSize: '0.85rem', color: '#3a3a37' }}>Absence signalée</p>
          )}
          {!rsvp && (
            <p style={{ fontWeight: 300, fontSize: '0.85rem', color: '#a09d95' }}>En attente de réponse</p>
          )}
          <a href={`/invite/${slug}`}
        ...
        {guestData?.guest_message && (
          <div className="bg-white rounded-2xl border border-stone-100 p-5 mb-3">
            <p style={labelStyle} className="mb-3">Mon message aux mariés</p>
        ...
        <div className="bg-white rounded-2xl border border-stone-100 p-5">
          <p style={labelStyle} className="mb-3">Accès</p>
