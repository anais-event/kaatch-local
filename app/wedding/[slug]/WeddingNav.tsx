    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-[#f5f0e8]/95 backdrop-blur border-b border-stone-200 shadow-sm">
      <div className="max-w-5xl mx-auto px-4 flex items-center gap-2 h-12">
        <a href={`/wedding/${slug}`}
           ...
           className="text-[#2d3228] shrink-0 mr-3">
          {weddingName}
        </a>
        ...
        <a href={`/invite/${slug}`}
          className="px-3 py-1 rounded-md text-xs whitespace-nowrap border border-[#4a5240] text-[#4a5240] hover:bg-[#4a5240] hover:text-white transition"
          style={{ fontFamily: 'var(--font-lato)', fontWeight: 300, letterSpacing: '0.04em' }}>
          Vue invité
        </a>
