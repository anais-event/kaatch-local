  ...
  return (
    <div className="flex items-center gap-2 shrink-0">
      ...
      <a href={url} target="_blank" rel="noopener noreferrer"
         className="flex items-center gap-1 px-3 py-2 rounded-lg border border-stone-200 text-stone-500 hover:border-[#4a5240] hover:text-[#4a5240] transition text-sm"
         style={{ fontWeight: 300 }}>
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} className="w-3.5 h-3.5 shrink-0">
