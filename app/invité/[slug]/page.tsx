    ...
    <div className="min-h-screen bg-[#f5f0e8]" style={{ fontFamily: 'var(--font-lato)' }}>
      ...
      <div className="bg-[#f5f0e8] sticky top-0 z-10 border-b border-stone-200 shadow-sm">
        <div className="max-w-2xl mx-auto flex justify-around px-4 pt-4 pb-0 overflow-x-auto">
          {[
            { label: 'Programme', href: `/invité/${slug}/programme` },
            { label: 'Photos', href: `/invité/${slug}/photos` },
            { label: 'Groupes', href: `/invité/${slug}/groupes` },
            { label: 'Contacts', href: `/invité/${slug}/contacts` },
          ].map((tab) => (
